...
class EventEdit extends StatefulWidget {
  EventEdit({this.eventID, this.userId});
...
class _EventEditState extends State<EventEdit> {
  ...
  getDataRespose() async {
    getData = await Firestore.instance
        .collection('events')
    ...
    dateController.text = getData['date'];
    timeController.text = getData['time'];
    titleController.text = getData['eventName'];
    descController.text = getData['desc'];
    setState(() {
      showSpinner = false;
    });
  }
  ...
  void initState() {
    ...
    ///events/Pxmv6gE3ich9J8skzspEMSadFcx1/events/dOEnV92HdMkasqFis2t1
  }
                              ...
                              onPressed: () {
                                if (_formKey.currentState.validate()) {
                                  ...
                                  LogicEvent().editEvent(
                                      ...
                                      eventid: widget.eventID).then((onValue) {
                                    MyUtils.toastMessage("Event Updated Successfully");
